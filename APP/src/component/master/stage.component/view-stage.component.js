...
const StageComponent = () => {
  ...
  const columnDefs = [
    ...
    { field: 'name', headerName: 'Stage Name' },
    { field: 'descriptions', headerName: 'Description' },
    { field: 'inOrder', headerName: 'Stage Order' },
...
class BtnCellRenderer extends Component {
  ...
  btnClickedHandler = _.debounce((spaceId, action) => {
    ...
    const buttonMap = {
      'E': (
        <Button
          ...
          onClick={() => this.btnClickedHandler(spaceId, 'edit')}
        >
          <Link to={`/edit-stage/${spaceId}`}>
            <FontAwesomeIcon
